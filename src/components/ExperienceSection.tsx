...
function ProjectBlock({ project }: { project: ProjectDetail }) {
  return (
    <div className="border-l-2 border-border pl-6 sm:pl-8">
      ...
      {project.description && (
        <div className="mt-5">
          <h5 className="mb-2 text-sm font-semibold text-muted">설명</h5>
      ...
      {project.roles && project.roles.length > 0 && (
        <div className="mt-5">
          <h5 className="mb-2 text-sm font-semibold text-muted">역할</h5>
      ...
      {project.tasks.length > 0 && (
        <div className="mt-5">
          <h5 className="mb-2 text-sm font-semibold text-muted">업무</h5>
          <ul className="list-disc space-y-3 pl-5 text-sm leading-relaxed text-foreground/85">
      ...
      {project.tech && project.tech.length > 0 && (
        <div className="mt-5">
          <h5 className="mb-2 text-sm font-semibold text-muted">사용 기술</h5>
